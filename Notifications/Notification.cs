...
{
    public DateTimeOffset DateToSend { get; private set; }
    public int HourToSend { get; private set; }
    ...
    /// <param name="dateToSend">The date on which the notification is scheduled to be sent. Must be a valid <see cref="DateTimeOffset"/> value.</param>
    /// <param name="hourToSend">The hour of the day (in 24-hour format) when the notification is scheduled to be sent. Valid values are between
    /// 0 and 23.</param>
    ...
    /// <param name="repeatable">A value indicating whether the notification is repeatable. <see langword="true"/> if the notification should be
    /// sent multiple times based on the frequency; otherwise, <see langword="false"/>.</param>
    /// <param name="enable">A value indicating whether the notification is enabled. <see langword="true"/> if the notification is active and
    /// should be sent; otherwise, <see langword="false"/>.</param>
    ...
    /// <param name="dateToSend">The date on which the notification should be sent. Must be a valid <see cref="DateTimeOffset"/> value.</param>
    ...
    /// <param name="repeatable">A value indicating whether the notification is repeatable. <see langword="true"/> if the notification should
    /// repeat; otherwise, <see langword="false"/>.</param>
    /// <param name="enable">A value indicating whether the notification is enabled. <see langword="true"/> to enable the notification;
